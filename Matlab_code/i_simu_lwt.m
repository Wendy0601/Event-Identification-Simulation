function [h_sol, flag_err] = i_simu_lwt(k,ks,k_inc,h,bus_sim,Y_g,Y_gnc,Y_ncg,Y_nc,rec_V1,rec_V2,bo)
...
kdc=10*(k-1)+1;
 ...
 if nload~=0
   ...
   [vnc,flag_err] = nc_load_lwt(bus_sim,flag,Y_nc,Y_ncg,int_volt,vnc,1e-5,k,kdc);
